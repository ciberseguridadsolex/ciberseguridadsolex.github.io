...
<body>
    ...
    <main>
        ...
        <section>
            ...
            <p>Sesión de usuario: <span id="userSession"></span></p>
    ...
    <script>
        // JavaScript para obtener y mostrar el número de visitante, sesión de usuario y hora de la visita
        ...
        // Obtiene la sesión de usuario
        var userSession = "Usuario"; // Reemplaza esto con la lógica real para obtener la sesión de usuario
        ...
        // Muestra el número de visitante, sesión de usuario y hora de la visita en el HTML
        document.getElementById('visitorNumber').textContent = visitorNumber;
        document.getElementById('userSession').textContent = userSession;
